...
fn process_input_file(input_path_notes: &Path) -> (String, Vec<String>) {
...
fn load_and_select_note_title(input_path_notes: &Path) -> (String, String) {
...
fn process_commands() {
    ...
    match cli.command {
        Commands::Delete { input_path_notes, output_path_notes } => {
            ...
            save_content(cleaned_content, &output_path_notes);
        },
        Commands::Parser { input_path_notes, output_path_notes } => {
            ...
            save_content(selected_title_content, &output_path_notes);
        },
